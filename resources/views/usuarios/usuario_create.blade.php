    ...
    <form action="{{route('usuarios.store')}}" method="POST">@csrf
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" name="nombres" id="nomrbes" maxlength="150" required>
                
            </div>
            <div class="col-md-3">
                <label for="">Apellidos</label>
                <input type="text" class="form-control" name="apellidos" id="apellidos" maxlength="150" required>
            </div>
            <div class="col-md-3">
                <label for="">Nro Stand</label>
                <input type="text" class="form-control" name="nro_stand" id="nro_stand" maxlength="150" required>
            </div>
            <div class="col-md-3">
                <label for="">Procedencia</label>
                <input type="text" class="form-control" name="procedencia" id="procedencia" maxlength="150" required>
            </div>
            <div class="col-md-3">
                <label for="">Linea Artesanal</label>
                <input type="text" class="form-control" name="linea_artesanal" id="nro_stand" maxlength="150" required>
            </div>
